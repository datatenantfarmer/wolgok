...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 27 18:08:32 2018

@author: chanheelee
"""
### 단층 neural network + no initailizer + no drop out + batch  
...
# 랜덤 초기치 + 단층 뉴를넷
W1 = tf.Variable(tf.random_normal([254, 10]))
...
train_Adam = tf.train.AdamOptimizer(learning_rate=0.08).minimize(cost)
