...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 27 23:22:11 2018
...
W1 = tf.get_variable("W1",shape=[254,254*2], initializer=tf.contrib.layers.xavier_initializer())
W1 = tf.get_variable("newW1",shape=[254,254*2], initializer=tf.contrib.layers.variance_scaling_initializer())
b1 = tf.Variable(tf.random_normal([254*2]))
L1 = tf.nn.sigmoid(tf.matmul(X, W1)+b1)

W2 = tf.Variable(tf.random_normal([254*2, 10]))
W2 = tf.get_variable("ei1",shape=[254*2,10], initializer=tf.contrib.layers.xavier_initializer())
W2 = tf.get_variable("W2",shape=[254*2,10], initializer=tf.contrib.layers.variance_scaling_initializer())
...
training_epochs =500 # epoch 횟수 지정
